...
export default function GeneralPostCollection({ collection_name, posts, grid=3 }) {
  ...
  return (
    <div className="relative pt-10 overflow-visible">
      <div className="absolute w-2/3 z-0 bg-[#FFF5EF] -left-[20%] aspect-square rounded-2xl"></div>
      <div className="relative z-20">
        ...
        <div className="flex items-center justify-around w-full p-4">
          <button className="inline-flex items-center justify-center px-8 py-4 font-sans font-semibold tracking-wide  rounded-lg h-[60px] hover:bg-gray-200">
            See All 
